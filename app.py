...
# Add tile layers for Map View and Satellite View
...
# Add a campus boundary radius (200 meters)
folium.Circle(
...
# Buildings data with initials and full names
buildings = [
...
# Add Layer Control to switch between Map View and Satellite View
